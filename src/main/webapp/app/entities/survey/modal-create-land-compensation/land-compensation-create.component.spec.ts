...
import { LandCompensationCreateComponent } from './land-compensation-create.component';

describe('LandCompensation Management Update Component', () => {
  let comp: LandCompensationCreateComponent;
  let fixture: ComponentFixture<LandCompensationCreateComponent>;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [LandCompensationCreateComponent],
      providers: [
        FormBuilder,
        {
      ...
      .overrideTemplate(LandCompensationCreateComponent, '')
      .compileComponents();

    fixture = TestBed.createComponent(LandCompensationCreateComponent);
