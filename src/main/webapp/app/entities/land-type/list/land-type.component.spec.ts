...
describe('LandType Management Component', () => {
  let comp: LandTypeComponent;
  let fixture: ComponentFixture<LandTypeComponent>;
  let service: LandTypeService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'land-type', component: LandTypeComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(LandTypeComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.landTypes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
