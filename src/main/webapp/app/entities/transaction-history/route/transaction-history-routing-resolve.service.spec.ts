...
describe('TransactionHistory routing resolve service', () => {
  ...
  let resultTransactionHistory: ITransactionHistory | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return new ITransactionHistory if id is not provided', () => {
      // GIVEN
      ...
      expect(resultTransactionHistory).toEqual(new TransactionHistory());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as TransactionHistory })));
      mockActivatedRouteSnapshot.params = { id: 123 };
