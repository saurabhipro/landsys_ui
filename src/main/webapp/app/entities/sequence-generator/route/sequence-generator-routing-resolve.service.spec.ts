...
describe('SequenceGenerator routing resolve service', () => {
  ...
  let resultSequenceGenerator: ISequenceGenerator | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return new ISequenceGenerator if id is not provided', () => {
      // GIVEN
      ...
      expect(resultSequenceGenerator).toEqual(new SequenceGenerator());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as SequenceGenerator })));
      mockActivatedRouteSnapshot.params = { id: 123 };
