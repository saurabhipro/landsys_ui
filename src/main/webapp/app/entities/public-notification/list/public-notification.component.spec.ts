...
describe('PublicNotification Management Component', () => {
  let comp: PublicNotificationComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'public-notification', component: PublicNotificationComponent }]),
      ...
      .overrideTemplate(PublicNotificationComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.publicNotifications?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
