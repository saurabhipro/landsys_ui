...
import { ModalCreatePaymentAdviceComponent } from './modal-create-advise.component';

describe('PaymentAdvice Management Update Component', () => {
  let comp: ModalCreatePaymentAdviceComponent;
  let fixture: ComponentFixture<ModalCreatePaymentAdviceComponent>;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [ModalCreatePaymentAdviceComponent],
      providers: [
        FormBuilder,
        {
      ...
      .overrideTemplate(ModalCreatePaymentAdviceComponent, '')
      .compileComponents();

    fixture = TestBed.createComponent(ModalCreatePaymentAdviceComponent);
