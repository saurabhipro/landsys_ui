...
describe('PaymentAdvice Management Component', () => {
  let comp: PaymentAdviceComponent;
  let fixture: ComponentFixture<PaymentAdviceComponent>;
  let service: PaymentAdviceService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'payment-advice', component: PaymentAdviceComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(PaymentAdviceComponent, '')
      .compileComponents();
